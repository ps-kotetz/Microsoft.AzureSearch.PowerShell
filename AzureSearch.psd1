#
# モジュール 'AzureSearch' のモジュール マニフェスト
#
# 生成者: tekokura
#
# 生成日: 2017/04/18
...
GUID = '107958d6-8a7f-4257-b2a7-d7fad777e3ee'

# このモジュールの作成者
Author = 'pskotetz'

# このモジュールの会社またはベンダー
CompanyName = 'pskotetz'

# このモジュールの著作権情報
Copyright = '(c) 2017 tekokura. All rights reserved.'

# このモジュールの機能の説明
Description = 'PowerShell Modules for AzureSearch'
